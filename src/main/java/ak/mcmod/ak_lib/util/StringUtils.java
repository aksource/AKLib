...
public class StringUtils {
    ...
    private static final Function<Map.Entry<IProperty<?>, Comparable<?>>, String> functionBlockStateBase = ObfuscationReflectionHelper.getPrivateValue(BlockStateBase.class, null, 1);
     ...
     * @return 含まれていたらtrue
     */
    public static boolean match(Set<String> set, IBlockState state) {
        Block block = state.getBlock();
